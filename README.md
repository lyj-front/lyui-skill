...
**macOS/Linux:**
```bash
git clone https://github.com/lyj-front/lyui-skill.git ~/.cursor/skills/lyui
```

**Windows:**
```bash
git clone https://github.com/lyj-front/lyui-skill.git %USERPROFILE%\.cursor\skills\lyui
```
...
```bash
git submodule add https://github.com/lyj-front/lyui-skill.git .cursor/skills/lyui
